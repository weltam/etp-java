...
public class GetResourcesResponse extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<GetResourcesResponse> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<GetResourcesResponse> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<GetResourcesResponse>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this GetResourcesResponse to a ByteBuffer.
  ...
  /**
   * Deserializes a GetResourcesResponse from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a GetResourcesResponse instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static GetResourcesResponse fromByteBuffer(
   ...
   */
  public GetResourcesResponse(java.util.List<Energistics.Etp.v12.Datatypes.Object.Resource> resources) {
   ...
   */
  public static Energistics.Etp.v12.Protocol.Discovery.GetResourcesResponse.Builder newBuilder() {
    return new Energistics.Etp.v12.Protocol.Discovery.GetResourcesResponse.Builder();
  }
   ...
   * @return A new GetResourcesResponse RecordBuilder
   */
  public static Energistics.Etp.v12.Protocol.Discovery.GetResourcesResponse.Builder newBuilder(Energistics.Etp.v12.Protocol.Discovery.GetResourcesResponse.Builder other) {
    if (other == null) {
      return new Energistics.Etp.v12.Protocol.Discovery.GetResourcesResponse.Builder();
    } else {
      return new Energistics.Etp.v12.Protocol.Discovery.GetResourcesResponse.Builder(other);
    }
  }
   ...
   * @return A new GetResourcesResponse RecordBuilder
   */
  public static Energistics.Etp.v12.Protocol.Discovery.GetResourcesResponse.Builder newBuilder(Energistics.Etp.v12.Protocol.Discovery.GetResourcesResponse other) {
    if (other == null) {
      return new Energistics.Etp.v12.Protocol.Discovery.GetResourcesResponse.Builder();
    } else {
      return new Energistics.Etp.v12.Protocol.Discovery.GetResourcesResponse.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GetResourcesResponse>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Energistics.Etp.v12.Protocol.Discovery.GetResourcesResponse.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Energistics.Etp.v12.Protocol.Discovery.GetResourcesResponse other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.resources)) {
        this.resources = data().deepCopy(fields()[0].schema(), other.resources);
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.Discovery.GetResourcesResponse.Builder setResources(java.util.List<Energistics.Etp.v12.Datatypes.Object.Resource> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.Discovery.GetResourcesResponse.Builder clearResources() {
      resources = null;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<GetResourcesResponse>
    WRITER$ = (org.apache.avro.io.DatumWriter<GetResourcesResponse>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<GetResourcesResponse>
    READER$ = (org.apache.avro.io.DatumReader<GetResourcesResponse>)MODEL$.createDatumReader(SCHEMA$);
