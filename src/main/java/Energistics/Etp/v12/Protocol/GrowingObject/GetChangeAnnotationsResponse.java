...
public class GetChangeAnnotationsResponse extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static Energistics.Etp.v12.Protocol.GrowingObject.GetChangeAnnotationsResponse.Builder newBuilder() {
    return new Energistics.Etp.v12.Protocol.GrowingObject.GetChangeAnnotationsResponse.Builder();
  }
   ...
   * @return A new GetChangeAnnotationsResponse RecordBuilder
   */
  public static Energistics.Etp.v12.Protocol.GrowingObject.GetChangeAnnotationsResponse.Builder newBuilder(Energistics.Etp.v12.Protocol.GrowingObject.GetChangeAnnotationsResponse.Builder other) {
    if (other == null) {
      return new Energistics.Etp.v12.Protocol.GrowingObject.GetChangeAnnotationsResponse.Builder();
    } else {
      return new Energistics.Etp.v12.Protocol.GrowingObject.GetChangeAnnotationsResponse.Builder(other);
    }
  }
   ...
   * @return A new GetChangeAnnotationsResponse RecordBuilder
   */
  public static Energistics.Etp.v12.Protocol.GrowingObject.GetChangeAnnotationsResponse.Builder newBuilder(Energistics.Etp.v12.Protocol.GrowingObject.GetChangeAnnotationsResponse other) {
    if (other == null) {
      return new Energistics.Etp.v12.Protocol.GrowingObject.GetChangeAnnotationsResponse.Builder();
    } else {
      return new Energistics.Etp.v12.Protocol.GrowingObject.GetChangeAnnotationsResponse.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GetChangeAnnotationsResponse>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Energistics.Etp.v12.Protocol.GrowingObject.GetChangeAnnotationsResponse.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Energistics.Etp.v12.Protocol.GrowingObject.GetChangeAnnotationsResponse other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.changes)) {
        this.changes = data().deepCopy(fields()[0].schema(), other.changes);
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.GrowingObject.GetChangeAnnotationsResponse.Builder setChanges(java.util.Map<java.lang.CharSequence,Energistics.Etp.v12.Datatypes.Object.ChangeResponseInfo> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.GrowingObject.GetChangeAnnotationsResponse.Builder clearChanges() {
      changes = null;
