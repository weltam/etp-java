...
public class ChannelMetadata extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<ChannelMetadata> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<ChannelMetadata>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this ChannelMetadata to a ByteBuffer.
  ...
  /**
   * Deserializes a ChannelMetadata from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a ChannelMetadata instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static ChannelMetadata fromByteBuffer(
      java.nio.ByteBuffer b) throws java.io.IOException {
    return DECODER.decode(b);
  }

   private java.util.List<Energistics.Etp.v12.Datatypes.ChannelData.ChannelMetadataRecord> channels;
   ...
   */
  public ChannelMetadata(java.util.List<Energistics.Etp.v12.Datatypes.ChannelData.ChannelMetadataRecord> channels) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: channels = (java.util.List<Energistics.Etp.v12.Datatypes.ChannelData.ChannelMetadataRecord>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.List<Energistics.Etp.v12.Datatypes.ChannelData.ChannelMetadataRecord> getChannels() {
    return channels;
  }
   ...
   */
  public void setChannels(java.util.List<Energistics.Etp.v12.Datatypes.ChannelData.ChannelMetadataRecord> value) {
    this.channels = value;
  }
   ...
   */
  public static Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelMetadata.Builder newBuilder() {
    return new Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelMetadata.Builder();
  }
   ...
   * @return A new ChannelMetadata RecordBuilder
   */
  public static Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelMetadata.Builder newBuilder(Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelMetadata.Builder other) {
    if (other == null) {
      return new Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelMetadata.Builder();
    } else {
      return new Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelMetadata.Builder(other);
    }
  }
   ...
   * @return A new ChannelMetadata RecordBuilder
   */
  public static Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelMetadata.Builder newBuilder(Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelMetadata other) {
    if (other == null) {
      return new Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelMetadata.Builder();
    } else {
      return new Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelMetadata.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ChannelMetadata>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelMetadata.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelMetadata other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.channels)) {
        this.channels = data().deepCopy(fields()[0].schema(), other.channels);
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelMetadata.Builder setChannels(java.util.List<Energistics.Etp.v12.Datatypes.ChannelData.ChannelMetadataRecord> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelMetadata.Builder clearChannels() {
      channels = null;
    ...
    public ChannelMetadata build() {
      try {
        ...
        record.channels = fieldSetFlags()[0] ? this.channels : (java.util.List<Energistics.Etp.v12.Datatypes.ChannelData.ChannelMetadataRecord>) defaultValue(fields()[0]);
        return record;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<ChannelMetadata>
    WRITER$ = (org.apache.avro.io.DatumWriter<ChannelMetadata>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<ChannelMetadata>
    READER$ = (org.apache.avro.io.DatumReader<ChannelMetadata>)MODEL$.createDatumReader(SCHEMA$);
