...
public class ChannelData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<ChannelData> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ChannelData> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<ChannelData>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this ChannelData to a ByteBuffer.
  ...
  /**
   * Deserializes a ChannelData from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a ChannelData instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static ChannelData fromByteBuffer(
   ...
   */
  public ChannelData(java.util.List<Energistics.Etp.v12.Datatypes.ChannelData.DataItem> data) {
    this.data = data;
  }
   ...
   */
  public static Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelData.Builder newBuilder() {
    return new Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelData.Builder();
  }
   ...
   * @return A new ChannelData RecordBuilder
   */
  public static Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelData.Builder newBuilder(Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelData.Builder other) {
    if (other == null) {
      return new Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelData.Builder();
    } else {
      return new Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelData.Builder(other);
    }
  }
   ...
   * @return A new ChannelData RecordBuilder
   */
  public static Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelData.Builder newBuilder(Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelData other) {
    if (other == null) {
      return new Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelData.Builder();
    } else {
      return new Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelData.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ChannelData>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelData.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelData other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.data)) {
        this.data = data().deepCopy(fields()[0].schema(), other.data);
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelData.Builder setData(java.util.List<Energistics.Etp.v12.Datatypes.ChannelData.DataItem> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.ChannelStreaming.ChannelData.Builder clearData() {
      data = null;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<ChannelData>
    WRITER$ = (org.apache.avro.io.DatumWriter<ChannelData>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<ChannelData>
    READER$ = (org.apache.avro.io.DatumReader<ChannelData>)MODEL$.createDatumReader(SCHEMA$);
