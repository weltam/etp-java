...
public class ChannelData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static Energistics.Etp.v12.Protocol.ChannelDataLoad.ChannelData.Builder newBuilder() {
    return new Energistics.Etp.v12.Protocol.ChannelDataLoad.ChannelData.Builder();
  }
   ...
   * @return A new ChannelData RecordBuilder
   */
  public static Energistics.Etp.v12.Protocol.ChannelDataLoad.ChannelData.Builder newBuilder(Energistics.Etp.v12.Protocol.ChannelDataLoad.ChannelData.Builder other) {
    if (other == null) {
      return new Energistics.Etp.v12.Protocol.ChannelDataLoad.ChannelData.Builder();
    } else {
      return new Energistics.Etp.v12.Protocol.ChannelDataLoad.ChannelData.Builder(other);
    }
  }
   ...
   * @return A new ChannelData RecordBuilder
   */
  public static Energistics.Etp.v12.Protocol.ChannelDataLoad.ChannelData.Builder newBuilder(Energistics.Etp.v12.Protocol.ChannelDataLoad.ChannelData other) {
    if (other == null) {
      return new Energistics.Etp.v12.Protocol.ChannelDataLoad.ChannelData.Builder();
    } else {
      return new Energistics.Etp.v12.Protocol.ChannelDataLoad.ChannelData.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ChannelData>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Energistics.Etp.v12.Protocol.ChannelDataLoad.ChannelData.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Energistics.Etp.v12.Protocol.ChannelDataLoad.ChannelData other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.data)) {
        this.data = data().deepCopy(fields()[0].schema(), other.data);
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.ChannelDataLoad.ChannelData.Builder setData(java.util.List<Energistics.Etp.v12.Datatypes.ChannelData.DataItem> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.ChannelDataLoad.ChannelData.Builder clearData() {
      data = null;
