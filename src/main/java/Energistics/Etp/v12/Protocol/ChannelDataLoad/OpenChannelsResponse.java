...
public class OpenChannelsResponse extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<OpenChannelsResponse> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<OpenChannelsResponse> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<OpenChannelsResponse>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this OpenChannelsResponse to a ByteBuffer.
  ...
  /**
   * Deserializes a OpenChannelsResponse from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a OpenChannelsResponse instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static OpenChannelsResponse fromByteBuffer(
      java.nio.ByteBuffer b) throws java.io.IOException {
    return DECODER.decode(b);
  }

   private java.util.Map<java.lang.CharSequence,Energistics.Etp.v12.Datatypes.ChannelData.OpenChannelInfo> channels;
   ...
   */
  public OpenChannelsResponse() {}

  /**
   * All-args constructor.
   * @param channels The new value for channels
   */
  public OpenChannelsResponse(java.util.Map<java.lang.CharSequence,Energistics.Etp.v12.Datatypes.ChannelData.OpenChannelInfo> channels) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: channels = (java.util.Map<java.lang.CharSequence,Energistics.Etp.v12.Datatypes.ChannelData.OpenChannelInfo>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.Map<java.lang.CharSequence,Energistics.Etp.v12.Datatypes.ChannelData.OpenChannelInfo> getChannels() {
    return channels;
  }
   ...
   */
  public void setChannels(java.util.Map<java.lang.CharSequence,Energistics.Etp.v12.Datatypes.ChannelData.OpenChannelInfo> value) {
    this.channels = value;
  }

  /**
   * Creates a new OpenChannelsResponse RecordBuilder.
   * @return A new OpenChannelsResponse RecordBuilder
   */
  public static Energistics.Etp.v12.Protocol.ChannelDataLoad.OpenChannelsResponse.Builder newBuilder() {
    return new Energistics.Etp.v12.Protocol.ChannelDataLoad.OpenChannelsResponse.Builder();
  }

  /**
   * Creates a new OpenChannelsResponse RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new OpenChannelsResponse RecordBuilder
   */
  public static Energistics.Etp.v12.Protocol.ChannelDataLoad.OpenChannelsResponse.Builder newBuilder(Energistics.Etp.v12.Protocol.ChannelDataLoad.OpenChannelsResponse.Builder other) {
    if (other == null) {
      return new Energistics.Etp.v12.Protocol.ChannelDataLoad.OpenChannelsResponse.Builder();
    } else {
      return new Energistics.Etp.v12.Protocol.ChannelDataLoad.OpenChannelsResponse.Builder(other);
    }
  }

  /**
   * Creates a new OpenChannelsResponse RecordBuilder by copying an existing OpenChannelsResponse instance.
   * @param other The existing instance to copy.
   * @return A new OpenChannelsResponse RecordBuilder
   */
  public static Energistics.Etp.v12.Protocol.ChannelDataLoad.OpenChannelsResponse.Builder newBuilder(Energistics.Etp.v12.Protocol.ChannelDataLoad.OpenChannelsResponse other) {
    if (other == null) {
      return new Energistics.Etp.v12.Protocol.ChannelDataLoad.OpenChannelsResponse.Builder();
    } else {
      return new Energistics.Etp.v12.Protocol.ChannelDataLoad.OpenChannelsResponse.Builder(other);
  ...
  /**
   * RecordBuilder for OpenChannelsResponse instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OpenChannelsResponse>
    implements org.apache.avro.data.RecordBuilder<OpenChannelsResponse> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Energistics.Etp.v12.Protocol.ChannelDataLoad.OpenChannelsResponse.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing OpenChannelsResponse instance
     * @param other The existing instance to copy.
     */
    private Builder(Energistics.Etp.v12.Protocol.ChannelDataLoad.OpenChannelsResponse other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.channels)) {
        this.channels = data().deepCopy(fields()[0].schema(), other.channels);
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.ChannelDataLoad.OpenChannelsResponse.Builder setChannels(java.util.Map<java.lang.CharSequence,Energistics.Etp.v12.Datatypes.ChannelData.OpenChannelInfo> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.ChannelDataLoad.OpenChannelsResponse.Builder clearChannels() {
      channels = null;
    ...
    public OpenChannelsResponse build() {
      try {
        OpenChannelsResponse record = new OpenChannelsResponse();
        record.channels = fieldSetFlags()[0] ? this.channels : (java.util.Map<java.lang.CharSequence,Energistics.Etp.v12.Datatypes.ChannelData.OpenChannelInfo>) defaultValue(fields()[0]);
        return record;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<OpenChannelsResponse>
    WRITER$ = (org.apache.avro.io.DatumWriter<OpenChannelsResponse>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<OpenChannelsResponse>
    READER$ = (org.apache.avro.io.DatumReader<OpenChannelsResponse>)MODEL$.createDatumReader(SCHEMA$);
