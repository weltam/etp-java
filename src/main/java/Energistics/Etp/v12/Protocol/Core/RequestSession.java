...
public class RequestSession extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<RequestSession> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a RequestSession instance decoded from the given buffer
  ...
  public static RequestSession fromByteBuffer(
   ...
   private Energistics.Etp.v12.Datatypes.Uuid clientInstanceId;
   ...
   private boolean serverAuthorizationRequired;
   ...
   * @param clientInstanceId The new value for clientInstanceId
   ...
   * @param serverAuthorizationRequired The new value for serverAuthorizationRequired
   * @param endpointCapabilities The new value for endpointCapabilities
   */
  public RequestSession(java.lang.CharSequence applicationName, java.lang.CharSequence applicationVersion, Energistics.Etp.v12.Datatypes.Uuid clientInstanceId, java.util.List<Energistics.Etp.v12.Datatypes.SupportedProtocol> requestedProtocols, java.util.List<Energistics.Etp.v12.Datatypes.SupportedDataObject> supportedDataObjects, java.util.List<java.lang.CharSequence> supportedCompression, java.util.List<java.lang.CharSequence> supportedFormats, java.lang.Long currentDateTime, java.lang.Long earliestRetainedChangeTime, java.lang.Boolean serverAuthorizationRequired, java.util.Map<java.lang.CharSequence,Energistics.Etp.v12.Datatypes.DataValue> endpointCapabilities) {
    ...
    this.serverAuthorizationRequired = serverAuthorizationRequired;
  ...
  public java.lang.Object get(int field$) {
    ...
    case 2: return clientInstanceId;
    case 3: return requestedProtocols;
    ...
    case 9: return serverAuthorizationRequired;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: clientInstanceId = (Energistics.Etp.v12.Datatypes.Uuid)value$; break;
    case 3: requestedProtocols = (java.util.List<Energistics.Etp.v12.Datatypes.SupportedProtocol>)value$; break;
    case 4: supportedDataObjects = (java.util.List<Energistics.Etp.v12.Datatypes.SupportedDataObject>)value$; break;
    case 5: supportedCompression = (java.util.List<java.lang.CharSequence>)value$; break;
    ...
    case 9: serverAuthorizationRequired = (java.lang.Boolean)value$; break;
   ...
   * @return The value of the 'clientInstanceId' field.
   */
  ...
  /**
   * Sets the value of the 'clientInstanceId' field.
   * @param value the value to set.
   */
  ...
  /**
   * Gets the value of the 'serverAuthorizationRequired' field.
   * @return The value of the 'serverAuthorizationRequired' field.
   */
  ...
  /**
   * Sets the value of the 'serverAuthorizationRequired' field.
   * @param value the value to set.
   */
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RequestSession>
    ...
    private Builder(Energistics.Etp.v12.Protocol.Core.RequestSession.Builder other) {
      ...
      if (isValidValue(fields()[2], other.clientInstanceId)) {
        this.clientInstanceId = data().deepCopy(fields()[2].schema(), other.clientInstanceId);
        fieldSetFlags()[2] = other.fieldSetFlags()[2];
      }
      if (isValidValue(fields()[3], other.requestedProtocols)) {
        this.requestedProtocols = data().deepCopy(fields()[3].schema(), other.requestedProtocols);
      ...
      if (isValidValue(fields()[9], other.serverAuthorizationRequired)) {
        this.serverAuthorizationRequired = data().deepCopy(fields()[9].schema(), other.serverAuthorizationRequired);
    ...
    /**
      * Sets the value of the 'clientInstanceId' field.
      * @param value The value of 'clientInstanceId'.
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.Core.RequestSession.Builder setClientInstanceId(Energistics.Etp.v12.Datatypes.Uuid value) {
    ...
    /**
      * Checks whether the 'clientInstanceId' field has been set.
      * @return True if the 'clientInstanceId' field has been set, false otherwise.
      */
    ...
    /**
      * Clears the value of the 'clientInstanceId' field.
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.Core.RequestSession.Builder clearClientInstanceId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.Core.RequestSession.Builder setSupportedDataObjects(java.util.List<Energistics.Etp.v12.Datatypes.SupportedDataObject> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.Core.RequestSession.Builder clearSupportedDataObjects() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.Core.RequestSession.Builder setSupportedCompression(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.Core.RequestSession.Builder setSupportedFormats(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.Core.RequestSession.Builder clearSupportedFormats() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.Core.RequestSession.Builder setCurrentDateTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.Core.RequestSession.Builder clearCurrentDateTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.Core.RequestSession.Builder setEarliestRetainedChangeTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.Core.RequestSession.Builder clearEarliestRetainedChangeTime() {
    ...
    /**
      * Sets the value of the 'serverAuthorizationRequired' field.
      * @param value The value of 'serverAuthorizationRequired'.
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.Core.RequestSession.Builder setServerAuthorizationRequired(boolean value) {
    ...
    /**
      * Checks whether the 'serverAuthorizationRequired' field has been set.
      * @return True if the 'serverAuthorizationRequired' field has been set, false otherwise.
      */
    public boolean hasServerAuthorizationRequired() {
      return fieldSetFlags()[9];
    }


    /**
      * Clears the value of the 'serverAuthorizationRequired' field.
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.Core.RequestSession.Builder clearServerAuthorizationRequired() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.Core.RequestSession.Builder setEndpointCapabilities(java.util.Map<java.lang.CharSequence,Energistics.Etp.v12.Datatypes.DataValue> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.Core.RequestSession.Builder clearEndpointCapabilities() {
    ...
    public RequestSession build() {
      try {
        ...
        record.clientInstanceId = fieldSetFlags()[2] ? this.clientInstanceId : (Energistics.Etp.v12.Datatypes.Uuid) defaultValue(fields()[2]);
        record.requestedProtocols = fieldSetFlags()[3] ? this.requestedProtocols : (java.util.List<Energistics.Etp.v12.Datatypes.SupportedProtocol>) defaultValue(fields()[3]);
        ...
        record.supportedCompression = fieldSetFlags()[5] ? this.supportedCompression : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[5]);
        ...
        record.serverAuthorizationRequired = fieldSetFlags()[9] ? this.serverAuthorizationRequired : (java.lang.Boolean) defaultValue(fields()[9]);
