...
public class Chunk extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4620125397842725931L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Chunk\",\"namespace\":\"Energistics.Etp.v12.Protocol.StoreNotification\",\"fields\":[{\"name\":\"blobId\",\"type\":{\"type\":\"fixed\",\"name\":\"Uuid\",\"namespace\":\"Energistics.Etp.v12.Datatypes\",\"size\":16,\"fullName\":\"Energistics.Etp.v12.Datatypes.Uuid\",\"depends\":[]}},{\"name\":\"data\",\"type\":\"bytes\"},{\"name\":\"final\",\"type\":\"boolean\"}],\"protocol\":\"5\",\"messageType\":\"9\",\"senderRole\":\"store\",\"protocolRoles\":\"store,customer\",\"multipartFlag\":true,\"fullName\":\"Energistics.Etp.v12.Protocol.StoreNotification.Chunk\",\"depends\":[\"Energistics.Etp.v12.Datatypes.Uuid\"]}");
   ...
   */
  public static Energistics.Etp.v12.Protocol.StoreNotification.Chunk.Builder newBuilder() {
    return new Energistics.Etp.v12.Protocol.StoreNotification.Chunk.Builder();
  }
   ...
   * @return A new Chunk RecordBuilder
   */
  public static Energistics.Etp.v12.Protocol.StoreNotification.Chunk.Builder newBuilder(Energistics.Etp.v12.Protocol.StoreNotification.Chunk.Builder other) {
    if (other == null) {
      return new Energistics.Etp.v12.Protocol.StoreNotification.Chunk.Builder();
    } else {
      return new Energistics.Etp.v12.Protocol.StoreNotification.Chunk.Builder(other);
    }
  }
   ...
   * @return A new Chunk RecordBuilder
   */
  public static Energistics.Etp.v12.Protocol.StoreNotification.Chunk.Builder newBuilder(Energistics.Etp.v12.Protocol.StoreNotification.Chunk other) {
    if (other == null) {
      return new Energistics.Etp.v12.Protocol.StoreNotification.Chunk.Builder();
    } else {
      return new Energistics.Etp.v12.Protocol.StoreNotification.Chunk.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Chunk>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Energistics.Etp.v12.Protocol.StoreNotification.Chunk.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Energistics.Etp.v12.Protocol.StoreNotification.Chunk other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.blobId)) {
        this.blobId = data().deepCopy(fields()[0].schema(), other.blobId);
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.StoreNotification.Chunk.Builder setBlobId(Energistics.Etp.v12.Datatypes.Uuid value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.StoreNotification.Chunk.Builder clearBlobId() {
      blobId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.StoreNotification.Chunk.Builder setData(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.StoreNotification.Chunk.Builder clearData() {
      data = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.StoreNotification.Chunk.Builder setFinal$(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Protocol.StoreNotification.Chunk.Builder clearFinal$() {
