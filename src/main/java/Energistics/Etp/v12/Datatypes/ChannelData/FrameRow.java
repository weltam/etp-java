...
public class FrameRow extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<FrameRow> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<FrameRow> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<FrameRow>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this FrameRow to a ByteBuffer.
  ...
  /**
   * Deserializes a FrameRow from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a FrameRow instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static FrameRow fromByteBuffer(
      java.nio.ByteBuffer b) throws java.io.IOException {
    return DECODER.decode(b);
  }

   private java.util.List<Energistics.Etp.v12.Datatypes.IndexValue> indexes;
   private java.util.List<Energistics.Etp.v12.Datatypes.ChannelData.FramePoint> points;
   ...
   */
  public FrameRow(java.util.List<Energistics.Etp.v12.Datatypes.IndexValue> indexes, java.util.List<Energistics.Etp.v12.Datatypes.ChannelData.FramePoint> points) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: indexes = (java.util.List<Energistics.Etp.v12.Datatypes.IndexValue>)value$; break;
    case 1: points = (java.util.List<Energistics.Etp.v12.Datatypes.ChannelData.FramePoint>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.List<Energistics.Etp.v12.Datatypes.ChannelData.FramePoint> getPoints() {
    return points;
  }
   ...
   * @param value the value to set.
   */
  public void setPoints(java.util.List<Energistics.Etp.v12.Datatypes.ChannelData.FramePoint> value) {
    this.points = value;
  }

  /**
   * Creates a new FrameRow RecordBuilder.
   * @return A new FrameRow RecordBuilder
   */
  public static Energistics.Etp.v12.Datatypes.ChannelData.FrameRow.Builder newBuilder() {
    return new Energistics.Etp.v12.Datatypes.ChannelData.FrameRow.Builder();
  }

  /**
   * Creates a new FrameRow RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new FrameRow RecordBuilder
   */
  public static Energistics.Etp.v12.Datatypes.ChannelData.FrameRow.Builder newBuilder(Energistics.Etp.v12.Datatypes.ChannelData.FrameRow.Builder other) {
    if (other == null) {
      return new Energistics.Etp.v12.Datatypes.ChannelData.FrameRow.Builder();
    } else {
      return new Energistics.Etp.v12.Datatypes.ChannelData.FrameRow.Builder(other);
    }
  }

  /**
   * Creates a new FrameRow RecordBuilder by copying an existing FrameRow instance.
   * @param other The existing instance to copy.
   * @return A new FrameRow RecordBuilder
   */
  public static Energistics.Etp.v12.Datatypes.ChannelData.FrameRow.Builder newBuilder(Energistics.Etp.v12.Datatypes.ChannelData.FrameRow other) {
    if (other == null) {
      return new Energistics.Etp.v12.Datatypes.ChannelData.FrameRow.Builder();
    } else {
      return new Energistics.Etp.v12.Datatypes.ChannelData.FrameRow.Builder(other);
  ...
  /**
   * RecordBuilder for FrameRow instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FrameRow>
    implements org.apache.avro.data.RecordBuilder<FrameRow> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Energistics.Etp.v12.Datatypes.ChannelData.FrameRow.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing FrameRow instance
     * @param other The existing instance to copy.
     */
    private Builder(Energistics.Etp.v12.Datatypes.ChannelData.FrameRow other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.indexes)) {
        this.indexes = data().deepCopy(fields()[0].schema(), other.indexes);
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Datatypes.ChannelData.FrameRow.Builder setIndexes(java.util.List<Energistics.Etp.v12.Datatypes.IndexValue> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Datatypes.ChannelData.FrameRow.Builder clearIndexes() {
      indexes = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Datatypes.ChannelData.FrameRow.Builder setPoints(java.util.List<Energistics.Etp.v12.Datatypes.ChannelData.FramePoint> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Datatypes.ChannelData.FrameRow.Builder clearPoints() {
      points = null;
    ...
    public FrameRow build() {
      try {
        FrameRow record = new FrameRow();
        record.indexes = fieldSetFlags()[0] ? this.indexes : (java.util.List<Energistics.Etp.v12.Datatypes.IndexValue>) defaultValue(fields()[0]);
        record.points = fieldSetFlags()[1] ? this.points : (java.util.List<Energistics.Etp.v12.Datatypes.ChannelData.FramePoint>) defaultValue(fields()[1]);
        return record;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<FrameRow>
    WRITER$ = (org.apache.avro.io.DatumWriter<FrameRow>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<FrameRow>
    READER$ = (org.apache.avro.io.DatumReader<FrameRow>)MODEL$.createDatumReader(SCHEMA$);
