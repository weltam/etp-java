...
public class DataValue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<DataValue> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<DataValue> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<DataValue>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this DataValue to a ByteBuffer.
  ...
  /**
   * Deserializes a DataValue from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a DataValue instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static DataValue fromByteBuffer(
   ...
   */
  public static Energistics.Etp.v12.Datatypes.DataValue.Builder newBuilder() {
    return new Energistics.Etp.v12.Datatypes.DataValue.Builder();
  }
   ...
   * @return A new DataValue RecordBuilder
   */
  public static Energistics.Etp.v12.Datatypes.DataValue.Builder newBuilder(Energistics.Etp.v12.Datatypes.DataValue.Builder other) {
    if (other == null) {
      return new Energistics.Etp.v12.Datatypes.DataValue.Builder();
    } else {
      return new Energistics.Etp.v12.Datatypes.DataValue.Builder(other);
    }
  }
   ...
   * @return A new DataValue RecordBuilder
   */
  public static Energistics.Etp.v12.Datatypes.DataValue.Builder newBuilder(Energistics.Etp.v12.Datatypes.DataValue other) {
    if (other == null) {
      return new Energistics.Etp.v12.Datatypes.DataValue.Builder();
    } else {
      return new Energistics.Etp.v12.Datatypes.DataValue.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DataValue>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Energistics.Etp.v12.Datatypes.DataValue.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Energistics.Etp.v12.Datatypes.DataValue other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.item)) {
        this.item = data().deepCopy(fields()[0].schema(), other.item);
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Datatypes.DataValue.Builder setItem(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.Datatypes.DataValue.Builder clearItem() {
      item = null;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<DataValue>
    WRITER$ = (org.apache.avro.io.DatumWriter<DataValue>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<DataValue>
    READER$ = (org.apache.avro.io.DatumReader<DataValue>)MODEL$.createDatumReader(SCHEMA$);
