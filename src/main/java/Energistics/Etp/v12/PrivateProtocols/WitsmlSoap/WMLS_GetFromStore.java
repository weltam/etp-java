...
public class WMLS_GetFromStore extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 649353717585340564L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"WMLS_GetFromStore\",\"namespace\":\"Energistics.Etp.v12.PrivateProtocols.WitsmlSoap\",\"fields\":[{\"name\":\"WMLtypeIn\",\"type\":\"string\"},{\"name\":\"XMLin\",\"type\":\"string\"},{\"name\":\"OptionsIn\",\"type\":\"string\"},{\"name\":\"CapabilitiesIn\",\"type\":\"string\"}],\"protocol\":\"2100\",\"messageType\":\"9\",\"senderRole\":\"customer\",\"protocolRoles\":\"store,customer\",\"multipartFlag\":false,\"fullName\":\"Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore\",\"depends\":[]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<WMLS_GetFromStore> ENCODER =
      new BinaryMessageEncoder<WMLS_GetFromStore>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<WMLS_GetFromStore> DECODER =
      new BinaryMessageDecoder<WMLS_GetFromStore>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<WMLS_GetFromStore> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<WMLS_GetFromStore> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<WMLS_GetFromStore> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<WMLS_GetFromStore>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this WMLS_GetFromStore to a ByteBuffer.
  ...
  /**
   * Deserializes a WMLS_GetFromStore from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a WMLS_GetFromStore instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static WMLS_GetFromStore fromByteBuffer(
   ...
   */
  public static Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore.Builder newBuilder() {
    return new Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore.Builder();
  }
   ...
   * @return A new WMLS_GetFromStore RecordBuilder
   */
  public static Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore.Builder newBuilder(Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore.Builder other) {
    if (other == null) {
      return new Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore.Builder();
    } else {
      return new Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore.Builder(other);
    }
  }
   ...
   * @return A new WMLS_GetFromStore RecordBuilder
   */
  public static Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore.Builder newBuilder(Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore other) {
    if (other == null) {
      return new Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore.Builder();
    } else {
      return new Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore.Builder(other);
   ...
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WMLS_GetFromStore>
    implements org.apache.avro.data.RecordBuilder<WMLS_GetFromStore> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.WMLtypeIn)) {
        this.WMLtypeIn = data().deepCopy(fields()[0].schema(), other.WMLtypeIn);
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore.Builder setWMLtypeIn(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore.Builder clearWMLtypeIn() {
      WMLtypeIn = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore.Builder setXMLin(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore.Builder clearXMLin() {
      XMLin = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore.Builder setOptionsIn(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore.Builder clearOptionsIn() {
      OptionsIn = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore.Builder setCapabilitiesIn(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Energistics.Etp.v12.PrivateProtocols.WitsmlSoap.WMLS_GetFromStore.Builder clearCapabilitiesIn() {
      CapabilitiesIn = null;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<WMLS_GetFromStore>
    WRITER$ = (org.apache.avro.io.DatumWriter<WMLS_GetFromStore>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<WMLS_GetFromStore>
    READER$ = (org.apache.avro.io.DatumReader<WMLS_GetFromStore>)MODEL$.createDatumReader(SCHEMA$);
